...
const ByteLab = ({ currency: initialCurrency }: { currency: string }) => {
  ...
  const options = {
    protein: [
      { name: 'Chicken Breast', p: 25, f: 3, c: 0, cal: 130, pricing: { 100: 0.90, 150: 1.35, 200: 1.80, 250: 2.25, 300: 2.70 } },
      { name: 'Chicken Thigh', p: 21, f: 9, c: 0, cal: 170, pricing: { 100: 0.90, 150: 1.35, 200: 1.80, 250: 2.25, 300: 2.70 } },
      { name: 'Ground Beef', p: 22, f: 12, c: 0, cal: 190, pricing: { 100: 1.80, 150: 2.70, 200: 3.60, 250: 4.50, 300: 5.40 } },
      { name: 'Peeled Shrimps', p: 20, f: 1, c: 0, cal: 95, pricing: { 100: 2.00, 150: 3.00, 200: 4.00, 250: 5.00, 300: 6.00 } },
      { name: 'Tuna Saku', p: 26, f: 1, c: 0, cal: 116, pricing: { 100: 2.40, 150: 3.60, 200: 4.80, 250: 6.00, 300: 7.20 } },
      { name: 'Canned Tuna', p: 24, f: 1, c: 0, cal: 110, pricing: { 100: 1.40, 150: 2.10, 200: 2.80, 250: 3.50, 300: 4.20 } },
      { name: 'Egg Whites', p: 11, f: 0, c: 1, cal: 52, pricing: { 100: 0.80, 150: 1.20, 200: 1.60, 250: 2.00, 300: 2.40 } },
      { name: 'Fried Tofu', p: 15, f: 8, c: 10, cal: 180, pricing: { 100: 1.00, 150: 1.50, 200: 2.00, 250: 2.50, 300: 3.00 } },
      { name: 'Skip', p: 0, f: 0, c: 0, cal: 0, pricing: {} },
    ],
    carb: [
      { name: 'White Rice', p: 3, f: 0, c: 28, cal: 130, pricing: { 100: 0.60, 150: 0.90, 200: 1.20, 250: 1.50, 300: 1.80 } },
      { name: 'Sweet Potato', p: 2, f: 0, c: 20, cal: 90, pricing: { 100: 0.80, 150: 1.20, 200: 1.60, 250: 2.00, 300: 2.40 } },
      { name: 'Potato', p: 2, f: 0, c: 17, cal: 77, pricing: { 100: 0.70, 150: 1.05, 200: 1.40, 250: 1.75, 300: 2.10 } },
      { name: 'Sweet Corn', p: 3, f: 1, c: 19, cal: 86, pricing: { 100: 1.00, 150: 1.50, 200: 2.00, 250: 2.50, 300: 3.00 } },
      { name: 'English Muffin', p: 6, f: 1, c: 45, cal: 220, pricing: { 1: 1.40, 2: 2.40 }, unit: 'PC' },
      { name: 'Cauli Rice', p: 2, f: 0, c: 4, cal: 25, pricing: { 100: 1.00, 150: 1.50, 200: 2.00, 250: 2.50, 300: 3.00 } },
      { name: 'Pasta', p: 6, f: 1, c: 25, cal: 140, pricing: { 100: 0.90, 150: 1.35, 200: 1.80, 250: 2.25, 300: 2.70 } },
      { name: 'Skip', p: 0, f: 0, c: 0, cal: 0, pricing: {} },
    ],
    veggies: [
