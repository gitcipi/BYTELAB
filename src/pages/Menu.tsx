    ...
    <div className="p-6 flex flex-col justify-between flex-grow">
      ...
      <div className="grid grid-cols-4 gap-2 border-t border-black/10 dark:border-border pt-4">
        <div className="flex flex-col">
          <span className="text-[8px] font-mono tracking-wider text-black font-bold dark:text-secondary/60 mb-0.5 uppercase">Cals</span>
          <span className="text-[10px] font-mono text-black dark:text-white font-bold">{meal.macros.energy}</span>
        </div>
        <div className="flex flex-col">
          <span className="text-[8px] font-mono tracking-wider text-accent-light dark:text-accent font-bold mb-0.5 uppercase">Prot</span>
          <span className="text-[10px] font-mono text-black dark:text-white font-bold">{meal.macros.protein}</span>
        </div>
        <div className="flex flex-col">
          <span className="text-[8px] font-mono tracking-wider text-black font-bold dark:text-secondary/60 mb-0.5 uppercase">Carb</span>
          <span className="text-[10px] font-mono text-black dark:text-white font-bold">{meal.macros.carbs}</span>
        </div>
        <div className="flex flex-col">
          <span className="text-[8px] font-mono tracking-wider text-black font-bold dark:text-secondary/60 mb-0.5 uppercase">Fat</span>
        ...
        <div className="w-full md:w-1/2 p-10 md:p-16 flex flex-col justify-center">
          ...
          <div className="grid grid-cols-4 gap-6 pt-10 border-t border-black/5 dark:border-border">
            <div className="space-y-1">
              <span className="block text-[10px] font-mono tracking-widest text-gray-400 dark:text-secondary/60 uppercase">Energy</span>
              <span className="text-xl font-mono text-black dark:text-white">{meal.macros.energy}</span>
            </div>
            <div className="space-y-1">
              <span className="block text-[10px] font-mono tracking-widest text-accent-light dark:text-accent font-bold uppercase">Protein</span>
              <span className="text-xl font-mono text-black dark:text-white">{meal.macros.protein}</span>
            </div>
            <div className="space-y-1">
              <span className="block text-[10px] font-mono tracking-widest text-gray-400 dark:text-secondary/60 uppercase">Carbs</span>
              <span className="text-xl font-mono text-black dark:text-white">{meal.macros.carbs}</span>
            </div>
            <div className="space-y-1">
              <span className="block text-[10px] font-mono tracking-widest text-gray-400 dark:text-secondary/60 uppercase">Fats</span>
...
const Menu = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-background transition-colors duration-500">
      ...
      <section className="py-24 border-b border-black/5 dark:border-border/50">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
