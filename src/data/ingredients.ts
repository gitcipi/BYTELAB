...
export const INGREDIENTS: Record<string, Ingredient[]> = {
  ...
  carb: [
    ...
    { name: 'Normal Wrap', p: 6, f: 4, c: 35, cal: 210, pricing: { 1: 0.74, 2: 1.40 }, unit: 'PC' },
    { name: 'Jumbo Wrap', p: 8, f: 6, c: 45, cal: 280, pricing: { 1: 0.74, 2: 1.40 }, unit: 'PC' },
    { name: 'English Muffin', p: 6, f: 1, c: 45, cal: 220, pricing: { 1: 1.30, 2: 2.50 }, unit: 'PC' },
