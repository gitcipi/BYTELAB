...
export const INGREDIENTS: Record<string, Ingredient[]> = {
  ...
  carb: [
    ...
    { name: 'Normal Wrap', p: 6, f: 4, c: 35, cal: 210, pricing: { 1: 0.74 }, unit: 'PC', weightPerPc: 45, max: 1 },
    { name: 'Jumbo Wrap', p: 8, f: 6, c: 45, cal: 280, pricing: { 1: 0.74 }, unit: 'PC', weightPerPc: 70, max: 1 },
