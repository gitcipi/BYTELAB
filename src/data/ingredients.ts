...
export const INGREDIENTS: Record<string, Ingredient[]> = {
  ...
  carb: [
    ...
    { name: 'Cauliflower Rice', p: 2, f: 0, c: 4, cal: 25, pricing: { 100: 0.80, 150: 1.20, 200: 1.60, 250: 2.00, 300: 2.40 } },
    { name: 'Fusilli Pasta', p: 6, f: 1, c: 25, cal: 140, pricing: { 50: 0.22, 75: 0.33, 100: 0.43, 125: 0.54 }, min: 50, max: 125, step: 25 },
    { name: 'Penne Pasta', p: 6, f: 1, c: 25, cal: 140, pricing: { 50: 0.22, 75: 0.33, 100: 0.43, 125: 0.54 }, min: 50, max: 125, step: 25 },
    { name: 'Spaghetti', p: 6, f: 1, c: 25, cal: 140, pricing: { 50: 0.22, 75: 0.33, 100: 0.43, 125: 0.54 }, min: 50, max: 125, step: 25 },
    { name: 'Wholewheat Pasta', p: 7, f: 1.5, c: 23, cal: 135, pricing: { 50: 0.25, 75: 0.38, 100: 0.50, 125: 0.63 }, min: 50, max: 125, step: 25 },
